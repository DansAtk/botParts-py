...
def registerCommands():
    global databaseC
    databaseC = commands.command('database', mSelf)
    ...
    databaseSetupC = commands.command('setup', databaseC)
    ...
    findTimezoneC = commands.command('timezone', findC)
    ...
    global botC
    botC = commands.command('bot', mSelf)
    botC.description = 'Bot controls and monitoring. Usable by bot owner only.'
    botC.function = 'botF'
    global botConfigC
    botConfigC = commands.command('config', botC)
    ...
    botConfigPushC = commands.command('push', botConfigC)
    ...
    botConfigPullC = commands.command('pull', botConfigC)
    ...
    botConfigTriggerC = commands.command('trigger', botConfigC)
    ...
    global botShutdownC
    botShutdownC = commands.command('shutdown', botC)
...
def databaseDeleteF(inputData):
    thisThread = commands.request_queue(inputData, filter_channel=True, filter_user=True)
    thisQ = thisThread['queue']
